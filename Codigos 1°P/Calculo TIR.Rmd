...
```{r}
source("C:/Users/Dell3000/Desktop/Facu/Analisis numerico/Analisis_numerico_Bacchini/Semana 2/Busqueda_raiz.R")
```
...
#para saber si esta ok paso la TEA a TNA (ver segun pago de intereses)
tasa1=(1+0.05/2)^2-1
...
```{r}
polinomio=function(r){return(-PM+precio(r,marcha[,"t"],marcha[,"CF"]))}
plot(tasas,polinomio(tasas),type="l",col="red")
abline(h=0)
raiz_biseccion(polinomio,0,0.2,10^-6,100)
